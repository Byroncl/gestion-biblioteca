...
@Component({
  selector: "app-perfil-recomendaciones-navbar",
  templateUrl: "./perfil-recomendaciones-navbar.component.html",
  styleUrl: "./perfil-recomendaciones-navbar.component.scss",
})
export class PerfilRecomendacionesNavbarComponent implements OnInit {
  menuVisible = false;
