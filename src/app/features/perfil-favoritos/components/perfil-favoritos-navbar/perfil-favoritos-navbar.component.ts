...
@Component({
  selector: "app-perfil-favoritos-navbar",
  templateUrl: "./perfil-favoritos-navbar.component.html",
  styleUrls: ["./perfil-favoritos-navbar.component.scss"],
})
export class PerfilFavoritosNavbarComponent implements OnInit {
  menuVisible = false;
